...
namespace SpinStatus
{
    internal static class Menu
    {
        ...
        internal static void Create()
        {
            ...
            CustomPage modPage = UIHelper.CreateCustomPage("SpinStatus_Menu");
            UIHelper.RegisterMenuInModSettingsRoot("SpinStatus_Menu_MenuName", modPage);
            modPage.OnPageLoad += modPageTransform =>
            {
                CustomGroup groupGeneral = UIHelper.CreateGroup(modPageTransform, "SpinStatus_Menu_General");
                ...
                CustomGroup groupEvents = UIHelper.CreateGroup(modPageTransform, "SpinStatus_Menu_Events");
                UIHelper.CreateSectionHeader(
                    groupEvents,
